...
public interface VersionStrategy {
     ...
     * @throws GittleCheckedException thrown if there is any problems loading the new version.
     */
    String getVersion(MavenProject mavenProject) throws GittleCheckedException;

    default String getVersion(Model model) {
        return "0.0.0";
    }
}
