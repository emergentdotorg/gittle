...
public class GitverConfigTest {
    ...
    public void getDefaults() {
        ...
        assertThat(config).extracting("versionPattern", "versionOverride").containsExactly(VERSION_PATTERN_DEF, "");
    }
    ...
    public void setMiscellaneous() {
        GitverConfig config = GitverConfig.builder()
                ...
                .build();
        assertThat(config).extracting("versionPattern", "versionOverride").containsExactly("%t(-%c)", "1.2.3-SNAPSHOT");
    }
}
