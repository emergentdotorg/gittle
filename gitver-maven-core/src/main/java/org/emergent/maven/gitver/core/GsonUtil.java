...
public class GsonUtil {
    ...
    private GsonUtil(boolean pretty) {
        this.pretty = pretty;
        GsonBuilder builder = getGsonBuilder(getTypeAdapters());
        if (pretty) {
    ...
    static GsonBuilder getGsonBuilder(Map<Class<?>, Object> typeAdapters) {
...
//                .setFieldNamingStrategy(new MyFieldNamingStrategy())
    ...
    static JsonElement flatten(JsonElement src) {
    ...
    static JsonElement rebuild(JsonElement in) {
