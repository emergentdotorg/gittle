...
@Disabled
@MojoTest
public class VersionInferenceMojoTest {
    ...
    @Test
    @InjectMojo(goal = "verinf", pom = "src/test/resources/project-to-test/pom.xml")
    public void testPrint(VersionInferenceMojo mojo) throws Exception {
