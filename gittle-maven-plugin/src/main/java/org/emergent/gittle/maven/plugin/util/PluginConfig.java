...
public class PluginConfig {
    ...
    public static @Nullable PluginConfig of(MavenProject project, PlexusContainer container)
            throws MavenExecutionException {
        // Lookup this plugin's configuration from the project
        Plugin plugin = project.getPlugin(FULL_PLUGIN_NAME);
        if (plugin == null) {
            return null;
        }
        ...
        return new PluginConfig(
                ...
                getStrategy(pluginConfigDom, project.getFile(), container)
        );
    }
